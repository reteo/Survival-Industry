...
purgeSmeltingRecipe("EnderIO:itemPowderIngot:1");
purgeSmeltingRecipe("EnderIO:itemPowderIngot:2");
purgeSmeltingRecipe("EnderIO:itemPowderIngot:3");
purgeSmeltingRecipe("EnderIO:itemPowderIngot:4");
purgeSmeltingRecipe("EnderIO:itemPowderIngot:8");
