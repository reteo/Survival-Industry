...
addOreDict("foodHoneydrop",			"dropHoney");
addOreDict("listAllsugar",			"dropHoney");
...
hideFromNEI("rftools:machineFrame");
hideFromNEI("harvestcraft:apiary:0");
hideFromNEI("harvestcraft:royaljellyItem:0");
...
if(isModLoaded("Forestry") && isModLoaded("harvestcraft")){
	...
	removeOreDict("harvestcraft:waxcombItem","materialPressedwax");
	...
	removeOreDict("harvestcraft:beeswaxItem","beeComb");
