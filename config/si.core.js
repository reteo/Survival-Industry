...
SI.addItem("foodJPMorningSupreme",	"SICoreFood",		1,	"si.core")
	.fooddata(SI.FoodData(16,1.600000023841858,false,false).buffdata("digspeed", 60, 1, 100));
SI.addItem("toolChiselFlint",		"SIToolChisel",		1,	"si.core").tooldata(SI.ToolData("FLINT").durability(64));
SI.addItem("toolChiselBedrock",		"SIToolChisel",		1,	"si.core").tooldata(SI.ToolData("BEDROCK").hasModes(true));
...
SI.addToolMaterial( 	"BEDROCK", 				7,   0, 8.0,3.0,10,	"RotaryCraft:ingotBedrock");
...
SI.addShapelessRecipe(cherenkov,				[plutonium,"minecraft:ender_pearl"]);
...
[	[cdInAgIngot,	cdInAgIngot,	cdInAgIngot],
	[cdInAgIngot,	cdInAgIngot,	cdInAgIngot],
	[cdInAgIngot,	cdInAgIngot,	cdInAgIngot]
]);
...
SI.addShapedRecipe("rftools:machineFrame", 
[	["ingotIron",	bedrockDust,	"ingotIron"	],
	["goldnugget", 	null,		"goldnugget"	],
	["ingotIron",	bedrockDust,	"ingotIron"	]
]);
		
SI.addShapedRecipe("harvestcraft:potItem", 
[	["stickWood",	"ingotBrick",	"ingotBrick"	],
	[null, 		"ingotBrick",	"ingotBrick"	],
	[null,		null,		null		]
]);
		
SI.addShapedRecipe("harvestcraft:skilletItem", 
[	["ingotBrick",	null,		null		],
	[null, 		"ingotBrick",	null		],
	[null,		null,		"stickWood"	]
]);
		
SI.addShapedRecipe("harvestcraft:saucepanItem",
[	["ingotBrick",	null,		null	],
	[null, 		"stickWood",	null	],
	[null,		null,		null	]
]);
		
SI.addShapedRecipe("harvestcraft:cuttingboardItem", 
[	["itemFlint",	null,		null		],
	[null, 		"stickWood",	null		],
	[null,		null,		"plankWood"	]
]);
		
SI.addShapedRecipe("minecraft:enchanting_table", 
...
SI.addShapedRecipe("eplus:tableUpgrade", 
...
SI.addShapedRecipe("eplus:advancedEnchantmentTable",
[	["blockGlassRed",		"blockGlassGreen",		"blockGlassBlue"					],
	["OpenComputers:item:25", 	"blockGlassColorless",		"ElectriCraft:electricraft_item_battery"		],
