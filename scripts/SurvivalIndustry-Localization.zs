/* Thermal Foundation has some very... unusual naming conventions for their
   ...
   with other mods, and the names are applied to several items associated with these
   ores.  Let's change the names to their modern equivalents. */
