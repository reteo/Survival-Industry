...
//
//    The Vegan Option's Plant Mil Recipe introduces an item dupe bug with RoCs Autocrafter;
//    let's work around that.

(function(){
    // if Vegan Option is loaded...
    if(isModLoaded("VeganOption")){
	// ...purge the old recipe...
	removeRecipes("VeganOption:bucketPlantMilk");
	...
	// ...assign the new item to the proper ore dictionary...
	addOreDict("SurvivalIndustry:itemPlantMilk","listAllmilk");
	// ...and add a proper shapeless recipe!
	addShapelessRecipe("SurvivalIndustry:itemPlantMilk", 
			   ["listAllwater","listAllsugar","sourcePlantMilk@2"]);
    }
})();
